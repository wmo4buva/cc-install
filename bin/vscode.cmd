...
REM Usage: bin\vscode.cmd  (or "ccvscode" once shortcuts are installed)
REM
...
cd /d "%~dp0.."
powershell.exe -NoProfile -ExecutionPolicy Bypass -File "%~dp0..\scripts\launchers\run_vscode.ps1" %*
